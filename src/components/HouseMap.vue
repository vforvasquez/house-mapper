    ...
    try {
      ...
      const infoWindowContent = `
        <div class="house-popup">
          ...
          <p><strong>Fire Risk:</strong> ${fireRisk}</p>
          <p><strong>Heat Risk:</strong> ${heatRisk}</p>
          ${house.hdpUrl ? `<a href="https://www.zillow.com${house.hdpUrl}" target="_blank">View Details</a>` : ''}
        </div>
      `
